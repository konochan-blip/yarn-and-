      ...
      <div className="mypage-overlay">
        ...
        <div className="mypage-body">
          <div className="mypage-profile-card">
            ...
            {profile?.knitting_since && <div style={{ fontSize: '12px', color: 'var(--text-primary)', marginBottom: '6px', textDecoration: 'underline wavy', textDecorationColor: 'var(--accent)', textUnderlineOffset: '3px' }}>🧶 編み物歴 {knittingAge(profile.knitting_since)}</div>}
