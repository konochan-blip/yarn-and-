    ...
    <div style={{ fontFamily: 'var(--font-sans)', background: 'var(--bg)', color: 'var(--text-primary)', minHeight: '100vh' }}>
      ...
      <section style={{ textAlign: 'center', padding: '72px 24px 60px', background: 'linear-gradient(160deg, #FFF0F4 0%, #FDF5F7 60%, #F5EEF8 100%)' }}>
        ...
        <h1 style={{ fontFamily: 'var(--font-serif)', fontSize: 'clamp(26px, 6vw, 42px)', fontWeight: 600, lineHeight: 1.45, color: 'var(--text-primary)', marginBottom: '18px' }}>
          あの毛糸、どこだっけ？<br /><span style={{ color: 'var(--accent)' }}>もう迷わない。</span>
        </h1>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', marginTop: '48px' }}>
          <div style={{ width: '100%', maxWidth: '360px', position: 'relative' }}>
            ...
            <div style={{ position: 'absolute', top: '14px', left: '50%', transform: 'translateX(-50%)', display: 'inline-block', background: 'var(--accent-light)', border: '1px solid var(--border)', borderRadius: '99px', padding: '5px 16px', fontSize: '12px', color: 'var(--accent)', fontWeight: 600, letterSpacing: '0.04em', whiteSpace: 'nowrap' }}>
              毛糸も作品も、スマホにまとめて。
            </div>
          </div>
        </div>
