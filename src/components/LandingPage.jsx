export default function LandingPage({ onLogin, onSignup }) {
  return (
    <div style={{ fontFamily: 'var(--font-sans)', background: 'var(--bg)', color: 'var(--text-primary)', minHeight: '100vh' }}>
      ...
      <section style={{ background: 'var(--surface)', padding: '64px 24px' }}>
        <div style={{ maxWidth: '680px', margin: '0 auto' }}>
          <div style={{ fontSize: '11px', letterSpacing: '0.14em', color: '#C9A0B0', fontWeight: 600, marginBottom: '10px' }}>こんな方におすすめ<span style={{ display: 'inline-block', animation: 'pyon 2s ease-in-out infinite' }}>🐰</span></div>
