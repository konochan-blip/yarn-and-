      ...
      <div style={{ minHeight: '100vh', background: 'var(--bg)', maxWidth: '480px', margin: '0 auto' }}>
        ...
        <div style={{ padding: '24px 20px' }}>
          ...
          <div style={{ background: 'var(--surface)', borderRadius: '18px', border: '1px solid var(--border)', padding: '24px 20px', textAlign: 'center', marginBottom: '16px' }}>
            ...
            {profile.knitting_since && <div style={{ fontSize: '11px', color: 'var(--accent)', marginBottom: '6px', textDecoration: 'underline wavy', textDecorationColor: 'var(--accent)', textUnderlineOffset: '3px' }}>🧶 編み物歴 {knittingAge(profile.knitting_since)}</div>}
