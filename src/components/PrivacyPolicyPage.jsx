      ...
      <div style={{ maxWidth: '640px', margin: '0 auto', padding: '0 20px 60px' }}>
        ...
        <div style={{ fontFamily: 'var(--font-sans)', color: 'var(--text-primary)', lineHeight: 1.9 }}>
          ...
          <Section title="1. はじめに">
            YARN&amp;（以下「本サービス」）は、ユーザーのプライバシーを大切にし、個人情報の適切な取り扱いに努めます。本プライバシーポリシーでは、本サービスが収集する情報とその利用方法についてご説明します。本サービスをご利用いただくことで、本ポリシーの内容にご同意いただいたものとみなします。
          </Section>
          ...
          <Section title="5. 外部サービスの利用">
            ...
            <ul>
              <li><strong>Supabase：</strong>データベース・認証・ストレージの提供。ユーザーデータはSupabaseのサーバー（主に米国）に保存されます。日本国外にデータが保存される場合があります</li>
              <li><strong>Vercel：</strong>アプリのホスティング（米国）</li>
            </ul>
            <p style={{ marginTop: '8px' }}>なお、将来的にアクセス解析ツール等を導入する場合には、本ポリシーにてお知らせします。</p>
          </Section>
          ...
          <Section title="6. データの保管と安全性">
            <ul>
              ...
              <li>ただし、インターネット上での完全なセキュリティを保証するものではありません</li>
            </ul>
          </Section>

          <Section title="7. 公開情報について">
            プロフィールを「公開」に設定した場合、ユーザー名・自己紹介・アバター画像・作品・毛糸・道具・書籍データは、ログインしていない方を含む誰でも閲覧できる状態になります。公開範囲にご注意の上、設定をご管理ください。
          </Section>

          <Section title="8. ユーザーの権利">
            <p>ユーザーは以下の操作をいつでも行うことができます。</p>
            <ul>
          ...
          <Section title="9. Cookie・ローカルストレージについて">
            本サービスでは、ログイン状態の維持や設定の保存のために、ブラウザのローカルストレージおよびCookieを使用することがあります。現時点では広告目的のトラッキングは行っていません。将来的に解析ツールや広告を導入する場合は、本ポリシーにてお知らせします。
          </Section>
          ...
          <Section title="11. プライバシーポリシーの変更">
            本ポリシーは必要に応じて改定されることがあります。重要な変更がある場合はアプリ内でお知らせするよう努めます。変更後も本サービスを継続してご利用いただいた場合、改定後のポリシーに同意いただいたものとみなします。
          </Section>
